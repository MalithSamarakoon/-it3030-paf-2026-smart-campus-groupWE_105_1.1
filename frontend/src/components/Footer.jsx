            ...
            <div className="max-w-7xl mx-auto px-8 py-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                ...
                <div className="space-y-6">
                    ...
                    <p className="text-sm leading-relaxed">
                        Modernizing campus day-to-day operations through efficient asset management and streamlined maintenance workflows[cite: 47].
                    </p>
                ...
                <div>
                    ...
                    <div className="space-y-4 text-sm">
                        <p className="text-emerald-500 font-semibold italic">IT3030 - PAF 2026 [cite: 1]</p>
                        <p>Faculty of Computing, SLIIT [cite: 30]</p>
                        <p className="text-xs text-slate-500">Group ID: it3030-paf-2026-smart-campus-groupXX [cite: 116]</p>
                    </div>
                </div>
            </div>
